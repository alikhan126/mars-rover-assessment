from helper.direction import DIRECTION_MAP, DIRECTION_COMMANDS
from helper.exceptions import OutOfPlateauError
...
class Rover:
    ...
    def is_within_plateau(self):
        ...
        """
        is_within_top_right = (
            self.position[0] <= self.plateau[0] and self.position[1] <= self.plateau[1]
        )
